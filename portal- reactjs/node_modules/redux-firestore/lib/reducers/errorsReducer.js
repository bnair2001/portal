...
function errorsAllIds() {
  ...
  switch (type) {
    case LISTENER_ERROR:
    case ERROR:
      if (state.indexOf((0, _reducers.pathFromMeta)(meta)) !== -1) {
        return state;
      }
      return [].concat(_toConsumableArray(state), [(0, _reducers.pathFromMeta)(meta)]);
    case CLEAR_ERRORS:
      return [];
    case CLEAR_ERROR:
      return state.filter(function (lId) {
        return lId !== (0, _reducers.pathFromMeta)(meta);
      });
    default:
      return state;
  }
...
function errorsByQuery() {
  ...
  switch (type) {
    ...
    case CLEAR_ERROR:
      return _extends({}, state, _defineProperty({}, (0, _reducers.pathFromMeta)(meta), null));
    default:
      return state;
  }
}
