...
if (isset($_POST['btn-login'])) {
	...
	if (password_verify($password, $row['password']) && $count==1) {
		$_SESSION['userSession'] = "success";
		header("Location: http://homeworkportal-com.stackstaging.com/student.php");
	} else {
...
<div class="signin-form">
	...
	<div class="container">
       ...
       <tr><td></td><td> <span><a href="../careless/forgot.php">Forgot password</a></span></td></tr>
     	<hr />
