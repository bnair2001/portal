...
if($_COOKIE["topsecret"]=="HorseFireAnonymous4578")
{
    ...
    die("<h1>Sorry only one account per user</h1>");
}
session_start();
	...
	if ($count==0) {
		...
		if ($DBcon->query($query)) {
           setcookie("tps", "HorseFireAnonymous4578", time() + (1 * 365 * 24 * 60 * 60),'/');
            ...
            header('Location: http://www.theportal.co.nf/');
		}else {
	...
	<div class="container">
       ...
       <form class="form-signin" method="post" id="register-form">
        ...
        <div class="form-group">
            ...
            <a href="http://homeworkportal-com.stackstaging.com/" class="btn btn-default" style="float:right;">Back to the Portal</a>
        </div> 
